...
mod tests {
    ...
    #[test]
    fn xoshiro256ss_next_u32_high_bits() {
        let mut a = Xoshiro256StarStar::new(0xdead, 0xbeef, 0xcafe, 0xbabe);
        let mut b = Xoshiro256StarStar::new(0xdead, 0xbeef, 0xcafe, 0xbabe);
        assert_eq!(a.next_u32(), (b.next_u64() >> 32) as u32);
    }

    #[test]
    fn zero_seed_rejected() {
        let r = std::panic::catch_unwind(|| Xoshiro256StarStar::new(0, 0, 0, 0));
        assert!(r.is_err());
    }
}
