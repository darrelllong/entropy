...
///
/// SP 800-22 Appendix E lists aperiodic templates for m = 2..=21 only, and
...
/// Appendix E of SP 800-22 Rev 1a (2010), in increasing numeric order.
...
mod tests {
    ...
    /// Out-of-range template lengths (0, or large enough to overflow a shift),
